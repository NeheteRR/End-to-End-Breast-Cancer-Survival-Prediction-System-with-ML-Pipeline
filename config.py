...
FEATURE_COLS_PATH  = ARTIFACTS_DIR / "feature_cols.csv"
BACKGROUND_PATH    = ARTIFACTS_DIR / "background.pkl"
...
SURVIVAL_THRESHOLD_MONTHS = 60

TEST_SIZE    = 0.20
RANDOM_STATE = 42

LOGISTIC_REGRESSION_PARAMS = {"max_iter": 2000, "random_state": RANDOM_STATE}
RANDOM_FOREST_PARAMS       = {"n_estimators": 300, "max_depth": 10, "random_state": RANDOM_STATE}
XGBOOST_PARAMS             = {

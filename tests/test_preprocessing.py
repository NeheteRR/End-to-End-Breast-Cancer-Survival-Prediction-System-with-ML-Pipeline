...
from app.services.preprocessing import (
    clean_dataframe, create_chemo_response_label,
    drop_leakage_columns, select_features,
)
...
def test_clean_numeric_columns(raw_sample):
    ...
    assert df["Tumor Size"].dtype == float
...
def test_label_only_chemo_patients(raw_sample):
    df = clean_dataframe(raw_sample)
